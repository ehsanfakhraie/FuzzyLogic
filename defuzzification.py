...
def defuzzification(output_dict):
    ...
    if output_dict['healthy'] > 0:  # if the output of the fuzzy system is 1, the output is healthy
        # healthy is the numerator and denominator of the health defuzzyfication process
        healthy = health_defuzzy(output_dict['healthy'])
